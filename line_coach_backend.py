...
- ความยาวรวมไม่เกิน 8-10 บรรทัด เขียนให้จบประโยคเสมอ
- เขียนสั้นๆ ตรงประเด็น แต่ละบรรทัดไม่เกิน 1-2 ประโยค แนะนำเมนูแค่ 2 ตัวเลือกพอ
- ห้ามใช้ Markdown เด็ดขาด (ห้ามมี ** _ # หรือดอกจัน) เพราะ LINE แสดงไม่ได้ ใช้อิโมจินำบรรทัดแทน
- ลงท้ายด้วย "ครับ" เสมอ (เป็นโค้ชผู้ชาย) ห้ามใช้ "ค่ะ/คะ"
...
def handle_daily_summary(user_id):
    ...
    prompt = (ctx + "\n\nช่วยสรุปผลประจำวันแบบกระชับ ต้องมี:\n"
              ...
              "3) แนะนำเมนูเจาะจง+ปริมาณ ว่ากินอะไรถึงจะครบโปรตีน/แคลอรี่ที่เหลือ (ให้ 2 ตัวเลือกพอ บวกแล้วใกล้เคียงยอดที่ขาด)\n"
